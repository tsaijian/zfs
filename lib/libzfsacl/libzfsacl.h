...
#define ZFSACL_FLAGS_ALL   (ZFSACL_AUTO_INHERIT|ZFSACL_PROTECTED|ZFSACL_DEFAULTED)
...
#define ZFSACE_FULL_SET 	(ZFSACE_READ_DATA | ZFSACE_WRITE_DATA | \
    ...
    ZFSACE_WRITE_ATTRIBUTES | ZFSACE_DELETE | ZFSACE_READ_ACL | ZFSACE_WRITE_ACL | \
    ZFSACE_WRITE_OWNER | ZFSACE_SYNCHRONIZE)
